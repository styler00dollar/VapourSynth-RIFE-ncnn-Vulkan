...
- model: Model to use.
  ...
  - 30 = rife-v4.11 (ensemble=False)
  - 31 = rife-v4.12 (ensemble=False)

  ## My experimental custom models (only works with 2x)

  - 32 = sudo_rife4 (ensemble=False / fast=True)
  - 33 = sudo_rife4 (ensemble=True / fast=False)
  - 34 = sudo_rife4 (ensemble=True / fast=True)
