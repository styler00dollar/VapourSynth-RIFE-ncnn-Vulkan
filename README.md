...
- model: Model to use.
  ...
  - 25 = rife-v4.8 (ensemble=True)
  - 26 = rife-v4.9 (ensemble=False)
  - 27 = rife-v4.9 (ensemble=True)
  - 28 = rife-v4.10 (ensemble=False)
  - 29 = rife-v4.11 (ensemble=False)
  - 30 = rife-v4.12 (ensemble=False)

  ## My experimental custom models (only works with 2x)

  - 31 = sudo_rife4 (ensemble=False / fast=True)
  - 32 = sudo_rife4 (ensemble=True / fast=False)
  - 33 = sudo_rife4 (ensemble=True / fast=True)
